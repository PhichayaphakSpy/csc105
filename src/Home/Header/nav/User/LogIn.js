...
export const LogIn = () => {
    return (
        ...
        <button type="submit" class="btn btn-primary btn-ghost">Login</button><button type="submit" class="btn btn-primary btn-ghost">Sign up</button>
      </form>
    );
};
